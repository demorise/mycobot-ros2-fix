...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_package",
            default_value="mycobot_320_description",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_file",
            default_value="mycobot_320.urdf.xacro",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "moveit_config_file",
            default_value="mycobot_320.srdf.xacro",
    ...
    kinematics_yaml = load_yaml("mycobot_320_description", "config/kinematics.yaml")
    ...
    ompl_planning_yaml = load_yaml(
        "mycobot_320_description", "config/ompl_planning.yaml"
    )
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # Trajectory Execution Configuration
    # TODO(destogl): check how to use ros2_control's controllers-yaml
    controllers_yaml = load_yaml("mycobot_320_description", "config/controllers.yaml")
    moveit_controllers = {
